...
packages.used=c("glmnet", "ggplot2", "tidyverse", "pscl", "UBL", "ggraph", "igraph", "MASS", "lubridate", "e1071", "gridExtra", "penalizedLDA", "psych", "irr", "pROC", "caret", "zoo", "DMWR", "ROSE", "xgboost")
...
The team also attempted classification by penalized logistic regression, however, the model did not converge and this was ultimately unused for our two step models.
```{r}
# loading preprocessed data
load("./output/cleaned.Rdata")
# saved as "dat"
...
#Boosted Trees SMOTE + xgBoost 
#Boosted Trees SMOTE + Splines
